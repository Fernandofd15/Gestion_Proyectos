...
<div class="row page-title">
    <div class="col-md-12">
        ...
        <h4 class="mb-1 mt-0">Agregar usuario</h4>
    </div>
</div>
@endsection
            ...
            <div class="card-body">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputNombre" name="name" value="{{ old('name') }}" maxlength="70" autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputApellido">Apellido</label>
                        <input type="text" class="form-control" id="exampleInputApellido" name="last_name" value="{{old('last_name')}}" maxlength="70" autocomplete="off">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail">Correo</label>
                        <input type="email" class="form-control" id="exampleInputEmail" name="email" value="{{ old('email') }}" maxlength="70" autocomplete="off">
                    </div>
                  
                    <div class="form-group">
                        <label for="exampleInputTelefono">Telefono</label>
                        <input type="text" class="form-control" id="exampleInputTelefono" name="phone" value="{{ old('phone') }}" maxlength="20" autocomplete="off">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="checkmeout0" name="is_actived" {{ old('is_actived') ? 'checked' : '' }}>
